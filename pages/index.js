...
export default function Home() {
  ...
  async function updateProfile() {
    ...
    if (imageLink) user.imageLink = imageLink
...

          {
            Object.keys(profile).length ? (
              <div className="mb-4">
                ...
                {profile.imageLink && <img src={imageLink} />}
              </div>
            ) : null
          }
          ...
          }
          {
            loaded && (
              <>
                ...
                <input className="pt-4 rounded bg-gray-100 px-3 py-2 my-2" placeholder="Twitter username" onChange={e => setTwitter(e.target.value)} />
                <input className="pt-4 rounded bg-gray-100 px-3 py-2" placeholder="Profile image" onChange={e => setImageLink(e.target.value)} />
